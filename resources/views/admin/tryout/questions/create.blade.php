                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="question_text" id="question_text" rows="4"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-main-bg focus:ring-main-bg" required>{{ old('question_text') }}</textarea>
                    </div>

                    <!-- Image URL (Optional) -->
                    <div>
                        <label for="image_url" class="block text-sm font-medium text-gray-700">URL Gambar
                            (Opsional)</label>
                    ...
                    <!-- Pembahasan -->
                    <div>
                        <label for="explanation" class="block text-sm font-medium text-gray-700">Pembahasan
                            (Opsional)</label>
