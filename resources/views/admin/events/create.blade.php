<x-app-layout>
    ...
    <div class="container mx-auto px-4 sm:px-6 md:py-2 lg:px-8">
        <div class="bg-white p-6 md:p-8 rounded-xl shadow">
            <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" x-data="{ testParts: [''] }">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="question_count" id="question_count" value="{{ old('question_count') }}"
                ...
                <!-- Bagian Tes -->
                <div class="mb-6" x-data="{ testParts: [''] }">
