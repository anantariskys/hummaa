<a {{ $attributes->merge(['class' => 'flex items-center justify-center w-full px-4 py-3 bg-white border
border-main-bg rounded-lg font-semibold text-sm text-gray-700 hover:bg-gray-50 focus:outline-none
focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150']) }}>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" height="24"
        ...
        0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
              fill="#34A853"/>
        <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55
        1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
              fill="#FBBC05"/>
        <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1
